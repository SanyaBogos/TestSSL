...
using TestAspNetCoreNew.Data;
using TestAspNetCoreNew.Models;
using TestAspNetCoreNew.Services;
using TestAspNetCoreNew.Extensions;
using System.IO;
using System.Security.Cryptography.X509Certificates;

namespace TestAspNetCoreNew
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseHttpsRedirectService(certificate);
